...
class resnetv1(Network):
  ...
  def _decide_blocks(self):
    ...
    self._blocks_hm = [resnet_v1_block('hm_block1', base_depth=64, num_units=3, stride=2),
                       resnet_v1_block('hm_block2', base_depth=128, num_units=4, stride=2),
                       # use stride 1 for the last conv4 layer
                       resnet_v1_block('hm_block3', base_depth=256, num_units=6, stride=1),
                       resnet_v1_block('hm_block4', base_depth=512, num_units=3, stride=1)]
