...
if __name__ == '__main__':
	# res_anns = []
	# for item in json.load(open('../POSE/alpha-pose-results.json')):
	# 	if type(item['image_id']) == str:
	# 		item['image_id'] = int(item['image_id'].replace('.jpg', ''))
	# 	res_anns.append(item)
	...
	cocoEval.params.imgIds = imgIds#[item for item in sorted(gtCoco.getImgIds()) if item in imgIds]
